...
This template should help get you started developing with multi-page Svelte and TypeScript in Vite.

## Why node_modules committed?

so no need to `npm install` (3rd world country's problem)
